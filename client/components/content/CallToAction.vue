<template>
  <div class="relative isolate rounded-lg overflow-hidden bg-gray-900 mt-14">
    <div class="px-6 py-24 sm:px-6 sm:py-20 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Subscribe to the Blog</h2>
